 ...
 */
public class BlueDragonModel extends WREntityModel<BlueDragonEntity>
{
    ...
    @Override
    public void setRotationAngles(BlueDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void setLivingAnimations(BlueDragonEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
