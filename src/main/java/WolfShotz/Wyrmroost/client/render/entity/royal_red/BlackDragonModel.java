 ...
 */
public class BlackDragonModel extends WREntityModel<BlackDragonEntity>
{
    ...
    @Override
    public void setRotationAngles(BlackDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void setLivingAnimations(BlackDragonEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
