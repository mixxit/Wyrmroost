 ...
 */
public class OrangeDragonModel extends WREntityModel<OrangeDragonEntity>
{
    ...
    @Override
    public void setRotationAngles(OrangeDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void setLivingAnimations(OrangeDragonEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
