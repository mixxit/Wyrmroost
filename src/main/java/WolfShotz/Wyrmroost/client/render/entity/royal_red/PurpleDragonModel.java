 ...
 */
public class PurpleDragonModel extends WREntityModel<PurpleDragonEntity>
{
    ...
    @Override
    public void setRotationAngles(PurpleDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void setLivingAnimations(PurpleDragonEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
