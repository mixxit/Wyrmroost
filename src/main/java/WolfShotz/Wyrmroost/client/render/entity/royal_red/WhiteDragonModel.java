 ...
 */
public class WhiteDragonModel extends WREntityModel<WhiteDragonEntity>
{
    ...
    @Override
    public void setRotationAngles(WhiteDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void setLivingAnimations(WhiteDragonEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
