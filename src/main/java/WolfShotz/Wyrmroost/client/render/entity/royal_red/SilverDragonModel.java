 ...
 */
public class SilverDragonModel extends WREntityModel<SilverDragonEntity>
{
    ...
    @Override
    public void setRotationAngles(SilverDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void setLivingAnimations(SilverDragonEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
