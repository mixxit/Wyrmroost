 ...
 */
public class GreenDragonModel extends WREntityModel<GreenDragonEntity>
{
    ...
    @Override
    public void setRotationAngles(GreenDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void setLivingAnimations(GreenDragonEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
