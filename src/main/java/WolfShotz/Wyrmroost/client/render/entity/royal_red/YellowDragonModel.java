 ...
 */
public class YellowDragonModel extends WREntityModel<YellowDragonEntity>
{
    ...
    @Override
    public void setRotationAngles(YellowDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void setLivingAnimations(YellowDragonEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
