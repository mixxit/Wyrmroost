 ...
 */
public class RedDragonModel extends WREntityModel<RedDragonEntity>
{
    ...
    @Override
    public void setRotationAngles(RedDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void setLivingAnimations(RedDragonEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
